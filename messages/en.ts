...
export const en: typeof ko = {
  ...
  download: {
    okEyebrow: "Payment complete",
    okTitle: "Thank you for your purchase!",
    okDesc: "Download the GeoScore extension with the button below. We've also emailed you the same file.",
    ...
    blockedTitle: "You don't have download access",
    blockedDesc: "This page is only for users who have completed a purchase. Your download link is missing or has expired.",
  ...
  email: {
    customer: {
      ...
      intro:
        "Your GeoScore extension is ready. We've attached the zip file (.zip) to this email, and you can also download it with the button below.",
      ...
      footerNote: "Support: support@thegreat.io · This email was sent regarding your GeoScore purchase.",
    },
    notify: {
