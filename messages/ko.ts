export const ko = {
  ...
  geo: {
    eyebrow: "GEO란?",
    h2: "이제는 '검색 순위'가 아니라, AI의 답에 인용되어야 합니다",
    lead: "<b>GEO(생성형 엔진 최적화, Generative Engine Optimization)</b>는 ChatGPT·Perplexity·Gemini 같은 AI가 답을 만들 때 <b>당신의 페이지를 신뢰할 만한 출처로 인용</b>하도록 최적화하는 일입니다. 사람들은 점점 검색창 대신 AI에게 묻고, <b>AI가 언급하지 않는 브랜드는 사실상 보이지 않습니다.</b>",
    cards: [
      {
        ico: "🔎",
        h3: "검색에서 'AI의 답'으로",
        p: "사용자는 링크 10개 대신 합성된 답 하나를 받습니다. 그 답에 인용되지 못하면 트래픽·문의·매출의 기회를 통째로 놓칩니다.",
      },
      {
        ico: "🤝",
        h3: "인용은 곧 신뢰이자 매출",
        p: "AI가 당신을 출처로 지목하면, 잠재고객은 이미 '검증된 선택'으로 받아들입니다. 어떤 광고보다 강력한 추천이 됩니다.",
      },
      {
        ico: "🚀",
        h3: "지금이 선점 기회",
        p: "대부분의 사이트는 아직 AI 인용 기준을 모릅니다. 먼저 최적화한 곳이 AI 답변의 좁은 인용 자리를 차지합니다.",
      },
    ],
    closing: "AI 시대의 발견 가능성은 곧 비즈니스의 생존입니다. GeoScore는 그 확률을 점수로 보여주고, 무엇을 고치면 오르는지까지 알려줍니다.",
  },
  hero: {
    eyebrow: "Generative Engine Optimization",
    slides: [
      {
        line1: "AI가 나를 추천하지 않으면,",
        line2: "고객은 나를 찾지 못합니다",
        lead: "이제 사람들은 검색창이 아니라 <b>AI에게 묻습니다.</b> AI 답변에 인용되지 못하면, 당신의 비즈니스는 노출 기회 자체를 잃습니다.",
      },
      {
        line1: "키워드로 검색해 들어오는 시대는",
        line2: "저물고 있습니다",
        lead: "고객은 AI에게 묻고, <b>AI가 인용한 출처·추천</b>을 통해 들어옵니다. 그 좁은 '인용 자리'에 들어야 트래픽이 생깁니다.",
      },
      {
        line1: "AI에게 발견될 확률이",
        line2: "곧 매출이 됩니다",
        lead: "AI가 당신을 출처로 지목할수록 신뢰와 유입이 늘어납니다. <b>발견 가능성을 높이는 것</b>이 AI 시대의 성장 전략입니다.",
      },
      {
        line1: "내 페이지, AI가 인용할까?",
        line2: "클릭 한 번으로 채점",
        lead: "GeoScore가 당신의 페이지가 <b>AI에 인용될 만한지</b> 점수로 진단하고, <b>무엇을 어떻게 고치면</b> 확률이 오르는지 알려줍니다.",
      },
    ],
    ctaBuy: "지금 구매 · $19",
  ...
  download: {
    ...
    verifyDesc: "구매 시 사용한 이메일 주소를 입력하면 GeoScore 확장 프로그램을 다운로드할 수 있습니다.",
    emailLabel: "이메일 주소",
    emailPlaceholder: "you@example.com",
    verifyButton: "확인하고 다운로드",
    verifying: "확인 중…",
    invalidEmail: "올바른 이메일 주소를 입력하세요.",
    mismatch: "구매 정보와 일치하지 않는 이메일입니다. 결제 시 입력한 주소를 확인해주세요.",
    genericError: "확인에 실패했습니다. 잠시 후 다시 시도해주세요.",
    okEyebrow: "확인 완료",
    okTitle: "다운로드가 시작됩니다!",
    okDesc: "다운로드가 자동으로 시작되지 않으면 아래 버튼을 누르세요.",
    ...
    blockedTitle: "유효하지 않은 다운로드 링크",
    blockedDesc: "링크가 잘못되었거나 만료되었습니다 (구매 후 30일간 유효). 구매 확인 이메일의 링크를 다시 확인해주세요.",
  ...
  email: {
    customer: {
      ...
      intro:
        "GeoScore 확장 프로그램이 준비되었습니다. 아래 버튼을 눌러 다운로드 페이지로 이동한 뒤, 구매하신 이메일 주소를 입력하면 확장 프로그램을 받을 수 있습니다.",
      button: "다운로드 페이지 열기",
